...
{   
    ...
    fflush(stdin);
    printf("Digite o codigo da disciplina: "); scanf("%d", &aluno->codigo);
    fflush(stdin);
    printf("Digite o nome da disciplina: ");  fgets(aluno->nome_disciplina, 80, stdin);
    fprintf(file, "disciplina: %sCodigo: %d", aluno->nome_disciplina, aluno->codigo);
    fprintf(file, "\n\n");
    int i;
    for (i = 0; i < 40; i++){
...
{   
    ...
    for (i; i < 40; i++){
        if(aluno->turma[i].discente.matricula == 0){
            ...
            fprintf(file, "Discente = %sIdade: %d\n", aluno->turma[i].discente.nome, aluno->turma[i].discente.idade);
			fprintf(file, "Curso: %sCR: %.2f\nMatricula: %d", aluno->turma[i].discente.curso, aluno->turma[i].discente.CR, aluno->turma[i].discente.matricula); 
			fprintf(file, "\n\n"); 
            printf("\n\n");
            fclose(file);
            break;
...
{	
	...
	if (file == NULL){
    	...
    	for (i = 0; i < 40; i++){
        	if (aluno->turma[i].discente.matricula != 0){
				printf("Discente = %sIdade: %d\n", aluno->turma[i].discente.nome, aluno->turma[i].discente.idade);
				printf("Curso: %sCR: %.2f\nMatricula: %d\n", aluno->turma[i].discente.curso, aluno->turma[i].discente.CR, aluno->turma[i].discente.matricula);
				printf("Nota: %.2f\nFrequencia: %d%%", aluno->turma[i].notas, aluno->turma[i].frequencia);
				printf("\n\n");
